<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="frmSeatArrangement.aspx.cs" Inherits="OnlineExamSittingArrangement.frmSeatArrangement" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

   <div class="flt1 rp_inner"> <span class="flt rp_txtour">Room Allotment </span>
                    ...
                    <tr>
                        ...
                        <td class="style10" style="width: 181px" align="center" valign="middle">
                            <asp:Button ID="btnseatbook" runat="server" onclick="btnseatbook_Click" 
                                style="font-weight: 700" Text="Seat Book" />
                        </td>
                        <td class="style11" style="width: 63px">
                            &nbsp;</td>
                        <td class="style11" style="width: 79px">
